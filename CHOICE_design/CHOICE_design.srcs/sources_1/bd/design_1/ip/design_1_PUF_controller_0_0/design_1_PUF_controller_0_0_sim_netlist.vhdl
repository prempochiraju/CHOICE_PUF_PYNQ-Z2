...
--               c:/Users/ppochiraju2024/Desktop/CHOICE-PUF/CHOICE_design/CHOICE_design.srcs/sources_1/bd/design_1/ip/design_1_PUF_controller_0_0/design_1_PUF_controller_0_0_sim_netlist.vhdl
...
entity design_1_PUF_controller_0_0_pattern_ctrl_unit is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_PUF_controller_0_0_pattern_ctrl_unit : entity is "pattern_ctrl_unit";
end design_1_PUF_controller_0_0_pattern_ctrl_unit;

architecture STRUCTURE of design_1_PUF_controller_0_0_pattern_ctrl_unit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_PUF_controller_0_0_request_ctrl_unit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_PUF_controller_0_0_request_ctrl_unit : entity is "request_ctrl_unit";
end design_1_PUF_controller_0_0_request_ctrl_unit;

architecture STRUCTURE of design_1_PUF_controller_0_0_request_ctrl_unit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_PUF_controller_0_0_tune_ctrl_unit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_PUF_controller_0_0_tune_ctrl_unit : entity is "tune_ctrl_unit";
end design_1_PUF_controller_0_0_tune_ctrl_unit;

architecture STRUCTURE of design_1_PUF_controller_0_0_tune_ctrl_unit is
...
pattern_ctrl_unit_i: entity work.design_1_PUF_controller_0_0_pattern_ctrl_unit
     port map (
      ASR_choice(3 downto 0) => ASR_choice(3 downto 0),
      clk => clk,
      fill_req_s => fill_req_s,
...
req_ctrl_unit_i: entity work.design_1_PUF_controller_0_0_request_ctrl_unit
     port map (
      ASR_enable => \^asr_enable\,
      clk => clk,
      ff_reset => ff_reset,
...
tune_ctrl_unit_i: entity work.design_1_PUF_controller_0_0_tune_ctrl_unit
     port map (
...
entity design_1_PUF_controller_0_0 is
  ...
  attribute x_core_info of design_1_PUF_controller_0_0 : entity is "PUF_controller,Vivado 2020.1";
...
begin
  ...
  write_valid <= \^write_valid\;
U0: entity work.design_1_PUF_controller_0_0_PUF_controller
     port map (
      ASR_choice(3 downto 0) => ASR_choice(3 downto 0),
      ASR_enable => ASR_enable,
      ASR_tuning(19 downto 0) => ASR_tuning(19 downto 0),
